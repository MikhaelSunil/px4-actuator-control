...
class Metaclass_EscEepromRead(type):
    """Metaclass of message 'EscEepromRead'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4_msgs.msg.EscEepromRead')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__esc_eeprom_read
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__esc_eeprom_read
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__esc_eeprom_read
            cls._TYPE_SUPPORT = module.type_support_msg__msg__esc_eeprom_read
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__esc_eeprom_read
    ...
    def ORB_QUEUE_LENGTH(self):
        ...
        return Metaclass_EscEepromRead.__constants['ORB_QUEUE_LENGTH']


class EscEepromRead(metaclass=Metaclass_EscEepromRead):
    """
    Message class 'EscEepromRead'.
