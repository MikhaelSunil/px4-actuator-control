...
class Metaclass_GimbalDeviceAttitudeStatus(type):
    ...
    __constants = {
        ...
        'DEVICE_FLAGS_YAW_IN_VEHICLE_FRAME': 32,
        'DEVICE_FLAGS_YAW_IN_EARTH_FRAME': 64,
    }
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'DEVICE_FLAGS_YAW_IN_VEHICLE_FRAME': cls.__constants['DEVICE_FLAGS_YAW_IN_VEHICLE_FRAME'],
            'DEVICE_FLAGS_YAW_IN_EARTH_FRAME': cls.__constants['DEVICE_FLAGS_YAW_IN_EARTH_FRAME'],
        }
    ...
    @property
    def DEVICE_FLAGS_YAW_IN_VEHICLE_FRAME(self):
        """Message constant 'DEVICE_FLAGS_YAW_IN_VEHICLE_FRAME'."""
        return Metaclass_GimbalDeviceAttitudeStatus.__constants['DEVICE_FLAGS_YAW_IN_VEHICLE_FRAME']

    @property
    def DEVICE_FLAGS_YAW_IN_EARTH_FRAME(self):
        """Message constant 'DEVICE_FLAGS_YAW_IN_EARTH_FRAME'."""
        return Metaclass_GimbalDeviceAttitudeStatus.__constants['DEVICE_FLAGS_YAW_IN_EARTH_FRAME']
...
class GimbalDeviceAttitudeStatus(metaclass=Metaclass_GimbalDeviceAttitudeStatus):
    ...
    Constants:
      ...
      DEVICE_FLAGS_YAW_IN_VEHICLE_FRAME
