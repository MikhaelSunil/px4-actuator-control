...
class RaptorInput(metaclass=Metaclass_RaptorInput):
    ...
    def __init__(self, **kwargs):
        ...
        if 'linear_velocity' not in kwargs:
            ...
            self.linear_velocity = numpy.array(kwargs.get('linear_velocity'), dtype=numpy.float32)
        ...
        if 'previous_action' not in kwargs:
            ...
            self.previous_action = numpy.array(kwargs.get('previous_action'), dtype=numpy.float32)
            assert self.previous_action.shape == (4, )
