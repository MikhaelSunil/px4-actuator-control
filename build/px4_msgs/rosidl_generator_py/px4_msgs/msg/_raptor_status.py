...
class RaptorStatus(metaclass=Metaclass_RaptorStatus):
    ...
    def __init__(self, **kwargs):
        ...
        if 'internal_reference_position' not in kwargs:
            ...
            self.internal_reference_position = numpy.array(kwargs.get('internal_reference_position'), dtype=numpy.float32)
            assert self.internal_reference_position.shape == (3, )
        if 'internal_reference_linear_velocity' not in kwargs:
            ...
            self.internal_reference_linear_velocity = numpy.array(kwargs.get('internal_reference_linear_velocity'), dtype=numpy.float32)
            assert self.internal_reference_linear_velocity.shape == (3, )
