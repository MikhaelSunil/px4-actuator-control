...
#include "px4_msgs/msg/detail/ranging_beacon__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::msg::RangingBeacon & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::msg::RangingBeacon & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4_msgs
max_serialized_size_RangingBeacon(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_msgs::msg::RangingBeacon;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4_msgs
max_serialized_size_key_RangingBeacon(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::RangingBeacon *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::RangingBeacon *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RangingBeacon__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const px4_msgs::msg::RangingBeacon *>(
...
static size_t _RangingBeacon__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RangingBeacon(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RangingBeacon__callbacks = {
  "px4_msgs::msg",
  "RangingBeacon",
...
static rosidl_message_type_support_t _RangingBeacon__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RangingBeacon__callbacks,
...
get_message_type_support_handle<px4_msgs::msg::RangingBeacon>()
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_RangingBeacon__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, RangingBeacon)() {
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_RangingBeacon__handle;
}
