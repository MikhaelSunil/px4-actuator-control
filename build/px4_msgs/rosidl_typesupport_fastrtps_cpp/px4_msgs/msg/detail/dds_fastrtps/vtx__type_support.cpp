...
#include "px4_msgs/msg/detail/vtx__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::msg::Vtx & ros_message,
  ...
  size_t current_alignment)
{
  ...
  // Member: band_name
  {
    ...
    size_t item_size = sizeof(ros_message.band_name[0]);
  ...
  {
    size_t array_size = 4;
    size_t item_size = sizeof(ros_message.power_label[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_msgs::msg::Vtx;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::Vtx *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::Vtx *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Vtx__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const px4_msgs::msg::Vtx *>(
...
static size_t _Vtx__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Vtx(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Vtx__callbacks = {
  "px4_msgs::msg",
  "Vtx",
  _Vtx__cdr_serialize,
...
static rosidl_message_type_support_t _Vtx__handle = {
...
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_Vtx__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, Vtx)() {
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_Vtx__handle;
}
