...
#include "px4_msgs/msg/detail/aux_global_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::msg::AuxGlobalPosition & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::msg::AuxGlobalPosition & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_msgs::msg::AuxGlobalPosition;
    is_plain =
      (
      offsetof(DataType, lat_lon_reset_counter) +
      last_member_size
      ) == ret_val;
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4_msgs
max_serialized_size_key_AuxGlobalPosition(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::AuxGlobalPosition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::AuxGlobalPosition *>(
    untyped_ros_message);
...
get_message_type_support_handle<px4_msgs::msg::AuxGlobalPosition>()
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_AuxGlobalPosition__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, AuxGlobalPosition)() {
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_AuxGlobalPosition__handle;
}
